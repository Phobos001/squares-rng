...
mod squaresrng {    
    ...
    impl SquaresRNG {
        ...
        /// have equal counts 0 bits and 1 bits (32/32) in any order to be a valid key.
        ...
        fn rand_u64(&mut self) -> u64 {
            let mut x: u64 = u64::wrapping_mul(self.counter, KEYS_TABLE[self.key as usize]);
            let y: u64 = x;
            let z: u64 = u64::wrapping_add(y, KEYS_TABLE[self.key as usize]);
    ...
    pub fn test_f32_uniformality() {
        let mut rng: SquaresRNG = SquaresRNG::new(0, 0);
